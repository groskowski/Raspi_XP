...
sudo pip install certifi==2020.6.20
sudo pip install chardet==4.0.0
sudo pip install colorzero==1.1
sudo pip install distro==1.5.0
sudo pip install gpiozero==1.6.2
sudo pip install idna==2.10
sudo pip install mysql-connector-python==8.3.0
sudo pip install numpy==1.19.5
sudo pip install picamera2==0.3.12
sudo pip install pidng==4.0.9
sudo pip install piexif==1.1.3
sudo pip install Pillow==8.1.2
sudo pip install pip==20.3.4
sudo pip install python-apt==2.2.1
sudo pip install python-prctl==1.7
sudo pip install requests==2.25.1
sudo pip install RPi.GPIO==0.7.0
sudo pip install setuptools==52.0.0
sudo pip install simplejpeg==1.6.4
sudo pip install six==1.16.0
sudo pip install spidev==3.5
sudo pip install ssh-import-id==5.10
sudo pip install toml==0.10.1
sudo pip install ufw==0.36
sudo pip install urllib3==1.26.5
